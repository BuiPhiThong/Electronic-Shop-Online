...
public class listCategoryServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            List<Product> list1 = d.getTop5ProductByCid(cid1);
            List<Product> list2 = d.getTop5ProductByCid(cid2);
            Product top1 = d.getTop1Product();
            request.setAttribute("pdhome", list1);
            request.setAttribute("pdhome1", list2);

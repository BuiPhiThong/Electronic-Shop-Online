...
<html lang="en">
    ...
    <body>
        ...
        <div class="movies_section_2 layout_padding">
            <h2 class="letest_text"></h2>

            <div class="movies_main">
                <div class="iamge_movies_main " >

                    <c:forEach var="ps" items="${requestScope.productsearch}">

                        <div class="iamge_movies col-2" >
                            <div class="image_3">
                                <img src="${ps.image}" class="image" style="width:100%">
                                <div class="middle">
                                    <div class="playnow_bt"><a href="detailproduct?pid=${ps.id}">Buy Now</a></div>
                                </div>
                            </div>
                            <h1 class="code_text">${ps.name}</h1>
                            <div class="star_icon">
                                <ul>

                    ...
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <a href="ocrud"><button class="btn btn-secondary"  >Order(${requestScope.size})</button></a>
                                </div>
                            </div>
                        ...
                        <tbody>
                            ...
                            <c:forEach var="o" items="${requestScope.orderlist}">
                                ...
                                <tr>
                                    ...
                                    <c:set var="oid" value="${o.id}"/>
                                    <td>${oid}</td>
                                    <td>${o.date}</td>
                                    <td>${o.cusid}</td>
                                    <td>${o.totalmoneyorder}</td>
                                    <td>
                                        <a href="detail?id=${oid}&total=${o.totalmoneyorder}">Detail</a>

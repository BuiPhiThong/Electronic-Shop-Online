    ...
    <head>
        ...
        <script>
            ...
            function toDelete(id) {
                if (confirm("Bạn có muốn xóa Category với id=" + id + " không?")) {
                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <a href="ccrud"><button class="btn btn-secondary"  >Category(${requestScope.size})</button></a>
                                </div>
                                <div class="col">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <c:forEach var="cl" items="${requestScope.categorylist}">
                                <c:set value="${cl.id}" var="id"/>
                                <tr>
                                    <td>
                                        <span class="custom-checkbox">
